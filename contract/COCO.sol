...
contract COCOToken is ERC20,PoSTokenStandard,Ownable {
	...
	function editBaseInterest(uint amount) onlyOwner{
		maxMintProofOfStake = amount;
	}
	
	function editYearOneMultiplier (uint amount) onlyOwner{
		yearOneMultiplier = amount;
	}
	
	function editYearTwoMultiplier (uint amount) onlyOwner{
